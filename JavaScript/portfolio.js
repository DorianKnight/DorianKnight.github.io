...
function filterProjectList(allProjects) {
    ...
    // console.log("Pressed types: " + typeFilters);
    // console.log("Pressed tags: " + tagFilters);
    ...
    // console.log("Projects passed the filter \n", filteredProjectList);
...
function generateProjectHTML(projects) {
    // To get images that I've missed I will likely need to use AJAX

    // First I need to construct the HTML string based off of the JSON information
    // Then I need to fill in the information gaps as I'm creating the HTML string
